...
ax  = df['TxEntrega'].plot(yerr=errors, capsize=3, kind="bar", width=0.3, position=-0.5, rot= 0, hatch='\\',colormap='Pastel1')
ax2 = df['Relacao'].plot(yerr=errors, capsize=3, secondary_y=True, kind="bar", width=0.3, position=0.5, rot= 0, hatch='//')
# ax2 = ax.twinx()
