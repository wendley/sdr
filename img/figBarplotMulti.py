...
ifile="../sdr-data/traces/Multi.csv"
...
ax  = df['No12'].plot(yerr=errors, capsize=3, kind="bar", width=0.3, position=1.5, legend=True, rot= 0, hatch='\\',colormap='Pastel1')
ax2 = df['No14'].plot(yerr=errors, capsize=3, kind="bar", width=0.3, position=0.5, legend=True, mark_right=True, rot= 0, hatch='//')
ax3 = df['No16'].plot(yerr=errors, capsize=3, kind="bar", width=0.3, position=-0.5, legend=True, mark_right=True, rot= 0, hatch='.',colormap='Pastel2')
# ax2 = ax.twinx()
...
ax.legend(['Node12','Node14','Node16'],loc=4,frameon = True,framealpha=1,shadow=True)
