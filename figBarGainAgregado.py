...
ax  = df['Gain-index'].plot(yerr=errors, capsize=3, kind="bar", width=0.3, position=1, legend=True, rot= 0, hatch='\\',colormap='PuOr')
ax2 = df['CustoEnerg'].plot(secondary_y=True, kind="bar", width=0.3, position=0, rot= 0, hatch='//', legend=True, mark_right=True, colormap='summer')
# ax2 = ax.twinx()
ax.set_ylabel('Gain-index')
ax.set_ylim(10,95)
ax2.set_ylim(50000,122000)
