...
ax  = df['TxEntrega'].plot(yerr=errors, capsize=3, kind="bar", width=0.3, position=1, legend=True, rot= 0, hatch='\\',colormap='Set1')
ax2 = df['Relacao'].plot(yerr=errors, capsize=3, secondary_y=True, kind="bar", width=0.3, position=0, legend=True, mark_right=True, rot= 0, hatch='//',colormap='Accent')
# ax2 = ax.twinx()
